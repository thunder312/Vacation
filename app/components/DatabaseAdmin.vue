<template>
  <div class="database-admin">
    <div class="admin-header">
      <h2>🗄️ Datenbank-Administration</h2>
    ...
    <div class="admin-card">
      ...
      <div class="backup-actions">
        ...
        <button @click="downloadBackup" class="btn-secondary" :disabled="!lastBackup">
          📥 {{ t('admin.downloadLastBackup') }}
        </button>
      </div>
...
const downloadBackup = async () => {
  try {
    ...
    toast.error(t('admin.downloadError'))
  }
}
...
const downloadTemplate = () => {
  const template = [
    ['username', 'displayName', 'role', 'teamleadUsername', 'vacationDays'],
